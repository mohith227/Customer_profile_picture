...
namespace Codilar\CustomerProfilePicture\Ui\Component\Listing\Columns;
        ...
        if (isset($dataSource['data']['items'])) {
            ...
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                $picture_url = !empty($customer["profile_picture"]) ? $this->urlBuilder->getUrl(
                    'customer/index/viewfile/image/'.base64_encode($customer["profile_picture"])) : $this->viewFileUrl->getUrl('Codilar_CustomerProfilePicture::images/no-profile-photo.jpg');
